			...
			<View>
				<View style={{height:70,borderBottomWidth:1,borderBottomColor:'#333'}}>
					...
					<View style={{position:'absolute',right:0,bottom:20,flexDirection:'row'}}>
						<Icon name="heart-o" size={24} color="rgba(227,1,58,1)" style={{position:'relative',top:10}}/>
						<Text style={{color:'rgba(227,1,58,1)',fontSize:30}}>12000</Text>
					</View>
				</View>
				<View style={{height:70,borderBottomWidth:1,borderBottomColor:'#333'}}>
					<Text style={{fontSize:14,color:'rgba(155,155,155,1)'}}>Date</Text>
		...
		return Global.inbox_list.map(function(msg, i){
			...
			if(msg.hasImage){
				...
				if(self.state.isDelete){
					deletebtn = 
					<TouchableOpacity 
						onPress={()=>{self._addToDelete(msg.id,i)}} 
						style={{justifyContent:'center',width:40,height:240,alignItems:'center',backgroundColor:'#81C1E7'}}>
				...
				return (
					<View key={i} style={{flexDirection:'row'}}>
						...
						<TouchableOpacity onPress={()=>{
								...
								AppEventEmitter.emit('inbox.get');
								Global.inbox_list[i].is_read=true;
								Actions.inboxmessage({image:msg.image,title:msg.heading,id:msg.id,desc:msg.description,hasImage:true,msg_time:msg.msg_time})
							}}>
							<View style={{width:width-10,height:240, marginLeft:5,marginRight:5,borderBottomRightRadius:4,borderTopRightRadius:4,marginBottom:5}}>
								...
								<View refs="messageBackground" style={{flexDirection:'row',borderRadius:8,borderBottomRightRadius:8,borderTopRightRadius:8,width:width-10,height:100,backgroundColor:'rgba(103,103,103,0.8)',alignItems:'flex-start',paddingRight:20,paddingTop:5,justifyContent:'space-between'}}>
					...
					<View key={i} style={{flexDirection:'row'}}>
						...
						<TouchableOpacity style={{flexDirection:'row'}} key={i} 
							...
							<View style={{width:width-10,height:100,marginLeft:5,marginBottom:5,marginRight:5,borderBottomRightRadius:4,borderTopRightRadius:4}}>
								<View style={{flexDirection:'row',borderRadius:4,borderBottomRightRadius:4,borderTopRightRadius:4,width:width-10,height:100,backgroundColor:'rgba(103,103,103,0.8)',alignItems:'flex-start',paddingRight:20,paddingTop:5,justifyContent:'space-between'}}>
