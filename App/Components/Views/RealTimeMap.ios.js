...
class RealTimeMap extends Component {
  ...
  */
  ...
  componentDidMount(){
    var pathArr = [...Global.pathArr];
    this.setState({
      polylineCoords:pathArr
    });
  ...
  render() {
    var run_info = <View>
      ...
      <View style={{position:'relative',top:20,width:width,alignItems:'center',justifyContent:'space-around',flexDirection:'row'}}>
        <TouchableOpacity onPress={()=>{this.setState({share:true})}}><View style={{backgroundColor:'rgba(20,139,205,1)',height:40,width:160,alignItems:'center',justifyContent:'center',borderRadius:4}}><Text style={{color:'white',fontSize:12,fontWeight:'bold'}}>SHARE</Text></View></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  map: {
    ...
    height:(height)-Global.navbarHeight,
